...
namespace ConcoursCanin
{
    ...
    public partial class CONCOURSCANINEntities2 : DbContext
    {
        public CONCOURSCANINEntities2()
            : base("name=CONCOURSCANINEntities2")
        {
        }
        ...
        public virtual DbSet<BATARD> BATARD { get; set; }
        public virtual DbSet<CHIEN> CHIEN { get; set; }
        public virtual DbSet<CONCOURS> CONCOURS { get; set; }
        public virtual DbSet<DERACE> DERACE { get; set; }
        public virtual DbSet<PARTICIPE> PARTICIPE { get; set; }
        public virtual DbSet<PROPRIETAIRE> PROPRIETAIRE { get; set; }
        public virtual DbSet<VUEBATARD> VUEBATARD { get; set; }
        public virtual DbSet<VUERACE> VUERACE { get; set; }
